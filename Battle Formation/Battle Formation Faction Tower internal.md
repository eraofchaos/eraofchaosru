...
## Боевое построение Circle 1:
  ...
  |:-----|:--------------------|:---------|:-----------------:|:----------------:|
  | 1 | Tower - Damage Amplification | УРН отряда + **0.3** % | 150 |  **10** x [Гремлин](/units/Gremlin) |
  | 2 | Tower - Storm Assaulter | АТК + **0.9** % | 70 |   |
  | 3 | Tower - A Strike Hit | Удар по цели + **6**  | 150 |  **10** x [Гремлин](/units/Gremlin) |
  | 4 | Tower - Storm Assaulter | АТК + **0.5** %, ОЗ + **0.5** % | 70 |   |
  | 5 | Tower - Ingeniousness | Уклонение + **6**  | 150 |  **10** x [Гремлин](/units/Gremlin) |
  | 6 | Tower - Physical Trials | ОЗ + **0.9** % | 70 |   |
  | 7 | Tower - Shield Practice | Сокращение УРН отряда + **0.3** % | 150 |  **10** x [Гремлин](/units/Gremlin) |
  | 8 | Tower - Physical Trials | ОЗ + **0.9** % | 70 |   |
  | 9 | Tower - Rocklike Skin | Выносливость + **6**  | 150 |  **10** x [Гремлин](/units/Gremlin) |
  | 10 | Tower - Storm Assaulter | АТК + **0.5** %, ОЗ + **0.5** % | 70 |   |
  | 11 | Tower - Blaster | Критический удар + **5**  | 150 |  **10** x [Гремлин](/units/Gremlin) |
...
## Боевое построение Circle 2:
  ...
  |  Nr  |         Name        |  Bonus  | <i class="fas fa-flask"/>  |  <i class="fab fa-optin-monster"/> |
  |:-----|:--------------------|:---------|:-----------------:|:----------------:|
  | 1 | Tower - Damage Amplification | УРН отряда + **0.4** % | 160 |  **10** x [Гремлин](/units/Gremlin) |
  | 2 | Tower - Storm Assaulter | АТК + **1** % | 80 |   |
  | 3 | Tower - Storm Assaulter | АТК + **0.7** %, ОЗ + **0.3** % | 80 |   |
  | 4 | Tower - A Strike Hit | Удар по цели + **6**  | 160 |  **10** x [Каменная горгулья](/units/Stone Gargoyle) |
  | 5 | Tower - Storm Assaulter | АТК + **0.7** %, ОЗ + **0.3** % | 80 |   |
  | 6 | Tower - Physical Trials | АТК + **0.3** %, ОЗ + **0.7** % | 80 |   |
  | 7 | Tower - Ingeniousness | Уклонение + **6**  | 160 |  **10** x [Железный голем](/units/Iron Golem) |
  | 8 | Tower - Physical Trials | АТК + **0.3** %, ОЗ + **0.7** % | 80 |   |
  | 9 | Tower - Physical Trials | ОЗ + **1** % | 80 |   |
  | 10 | Tower - Shield Practice | Сокращение УРН отряда + **0.4** % | 160 |  **10** x [Железный голем](/units/Iron Golem) |
  | 11 | Tower - Physical Trials | ОЗ + **1** % | 80 |   |
  | 12 | Tower - Physical Trials | АТК + **0.3** %, ОЗ + **0.7** % | 80 |   |
  | 13 | Tower - Rocklike Skin | Выносливость + **7**  | 160 |  **10** x [Каменная горгулья](/units/Stone Gargoyle) |
  | 14 | Tower - Physical Trials | АТК + **0.3** %, ОЗ + **0.7** % | 80 |   |
  | 15 | Tower - Storm Assaulter | АТК + **0.7** %, ОЗ + **0.3** % | 80 |   |
  | 16 | Tower - Blaster | Критический удар + **5**  | 160 |  **10** x [Гремлин](/units/Gremlin) |
...
## Боевое построение Circle 3:
  ...
  |  Nr  |         Name        |  Bonus  | <i class="fas fa-flask"/>  |  <i class="fab fa-optin-monster"/> |
  |:-----|:--------------------|:---------|:-----------------:|:----------------:|
  | 1 | Tower - Damage Amplification | УРН отряда + **0.4** % | 180 |  **10** x [Каменная горгулья](/units/Stone Gargoyle) |
  | 2 | Tower - Storm Assaulter | АТК + **1.2** % | 90 |   |
  | 3 | Tower - Storm Assaulter | АТК + **1.2** % | 90 |   |
  | 4 | Tower - Storm Assaulter | АТК + **0.8** %, ОЗ + **0.4** % | 90 |   |
  | 5 | Tower - A Strike Hit | Удар по цели + **7**  | 180 |  **10** x [Железный голем](/units/Iron Golem) |
  ...
  | 9 | Tower - Ingeniousness | Уклонение + **7**  | 180 |  **10** x [Гремлин](/units/Gremlin) |
  | 10 | Tower - Physical Trials | АТК + **0.4** %, ОЗ + **0.8** % | 90 |   |
  | 11 | Tower - Physical Trials | ОЗ + **1.2** % | 90 |   |
  | 12 | Tower - Physical Trials | ОЗ + **1.2** % | 90 |   |
  | 13 | Tower - Shield Practice | Сокращение УРН отряда + **0.4** % | 180 |  **10** x [Гремлин](/units/Gremlin) |
  | 14 | Tower - Physical Trials | ОЗ + **1.2** % | 90 |   |
  | 15 | Tower - Physical Trials | ОЗ + **1.2** % | 90 |   |
  | 16 | Tower - Physical Trials | АТК + **0.4** %, ОЗ + **0.8** % | 90 |   |
  | 17 | Tower - Rocklike Skin | Выносливость + **8**  | 180 |  **10** x [Железный голем](/units/Iron Golem) |
  ...
  | 21 | Tower - Blaster | Критический удар + **6**  | 180 |  **10** x [Каменная горгулья](/units/Stone Gargoyle) |
...
## Боевое построение Circle 4:
  ...
  |  Nr  |         Name        |  Bonus  | <i class="fas fa-flask"/>  |  <i class="fab fa-optin-monster"/> |
  |:-----|:--------------------|:---------|:-----------------:|:----------------:|
  | 1 | Tower - Damage Amplification | УРН отряда + **0.5** % | 190 |  **20** x [Каменная горгулья](/units/Stone Gargoyle) |
  ...
  | 6 | Tower - A Strike Hit | Удар по цели + **8**  | 190 |  **20** x [Маг](/units/Mage) |
  ...
  | 11 | Tower - Ingeniousness | Уклонение + **8**  | 190 |  **20** x [Маг](/units/Mage) |
  ...
  | 16 | Tower - Shield Practice | Сокращение УРН отряда + **0.5** % | 190 |  **20** x [Маг](/units/Mage) |
  ...
  | 21 | Tower - Rocklike Skin | Выносливость + **10**  | 190 |  **20** x [Маг](/units/Mage) |
  ...
  | 26 | Tower - Blaster | Критический удар + **7**  | 190 |  **20** x [Каменная горгулья](/units/Stone Gargoyle) |
