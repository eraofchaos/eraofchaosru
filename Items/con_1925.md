 ...
 **Required Level to open:** 1
 ...
 1 You would get **ALL** items  from:
  ...
  | 2 | [Эпический набор компонентов артефактов](/ru/Items/con_1926/) | Используйте, чтобы выбрать один из сундуков компонентов: Возмездия, Призрака, Мертвого короля или Канона. | 
